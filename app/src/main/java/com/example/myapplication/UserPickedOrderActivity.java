...
public class UserPickedOrderActivity extends AppCompatActivity  {
    ...
    private void initDate() {
        Msg message = (Msg) getIntent().getSerializableExtra("tokenList");

        tokenList = (List<Shop>) message.getExtend().get("tokenList");

        goodsList_order = new ArrayList<>();
        for (Shop shop:tokenList) {
